...
from src.application.game_data.abcs import ILocalizationRepository
from src.application.game_data.schemas.localization import LocalizationGameData
from src.infrastructure.db.postgres.repositories.game_data.localization.sql.registry import (
    SQL,
)
